      ...
      >
        ...
        >
          ...
          <div className="relative z-10 max-w-2xl font-sans mx-auto py-12 px-4 space-y-6 text-2xl">
            ...
            <br />
            This was exemplified by the school's first headmaster Titus Mukunda (Previously Headmaster of Bishop Mahiaini Academy), who set the standard of discipline, high quality teaching and expectation of excellence which has continued till today.
            <br />
