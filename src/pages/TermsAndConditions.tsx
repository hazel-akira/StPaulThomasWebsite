...
const TermsAndConditions: React.FC = () => {
 return (
  <>  <Helmet>
    <title> Terms And Condition | Pioneer School</title>
  </Helmet>
  <div className="bg-[#083056]/20 min-h-screen text-[#083056] py-16 px-4"
  style={{ fontFamily: 'Times New Roman, serif' }}>
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <ul className="list-decimal list-inside space-y-2">
        ...
        <li>
          All fees should be paid directly into Pioneer School accounts
          only.
        </li>
        <li>
